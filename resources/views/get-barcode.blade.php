...
<div class="row">
    <div class="col-md-6 offset-md-3">
        ...
        <span><img src="../images/newlogo1.png" alt="gs1uganda-logo" style="width: 150px;height: 120px;"> <h4><strong style="color: #ff5721;">{{ucfirst(Auth()->user()->name)}}</strong> - Generate Barcodes For <em style="color:#ff5721; ">{{ $product->productname }}</em></h4></span>
         @if(count($errors) > 0)
        ...
        <form method="post" action="#">
            ...
            <div class="form-group">
                <label for="barcode-qty">Barcode Quantity:</label>
